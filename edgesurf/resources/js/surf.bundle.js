      ...
      13695: (e, t, s) => {
        ...
        class Y {
          ...
          storeEndlessStats() {
            ...
            he.recordGameEnd({
              ...
              loseCondition: s.caught ? "lives" /* "kraken" */ : "lives",
        ...
        class te {
          ...
          resetGameData() {
            this.game = {
              ...
              lives: {
                current: 5, // increase life count from 3 to 5
                max: 5,  // increase life count from 3 to 5
                numCollected: 0,
              },
              boosts: {
                current: 3, //game automatically starts with 3 boosts instead of 0
                max: 3,
                numCollected: 0,
                numUsed: 0,
              },
        ...
        class ze extends ve {
          ...
          crash() {
            ...
            te.sys.game.friend &&
              ...
              ue.sys.refreshDisplay(),
              te.sys.game.lives.current <= -2  //game continues evn after all visible lives have been lost.
                ? this.lose()
                : ((this.timer.crash = 1),
                  this.stopPlayerSpeed(),
                  (this.dist.immune = 96),
        ...
        class Ne {
          ...
          checkCollisions() {
            ...
            /**
             * Makes it so that Kraken does not result in loss of life.
             * Commented out is original code. Function below is new code.
             */
            ...
            for (let t = 0; t < n; t++) {
              const s = ke.sys.foe[t];
              if (this.collision(s, e) && !s.hit && s.timer.crash <= 0) {
                if (te.sys.game.shields.current > 0) {
                  s.crash();
                  e.useShield();
                } else if (e.swapped) {
                  s.crash();
                  ...
                  s.ending();
                  te.sys.game.lives.current -= 1; // Subtract one life
                }
              }
              for (let e = 0; e < r; e++) {
                const t = ke.sys.npc[e];
                if (this.collision(s, t) && t.timer.crash <= 0) {
                  t.crash();
                }
              }
            }
        ...
        class ht extends O.Z {
          constructor(e) {
            super(e),
              ...
              /**
               * Add name to Game Credits and Special Thanks.
               */
              at(this, "getGameCreditsModalBody", () =>
                a.createElement(
                  ...
                  a.createElement(
                    x.nv,
                    null,
                    "Parker Young, Scott Porterfield, Patrick Evan Little, Connor Smith, William Devereux, Adina Shanholtz. Reverse Changes made by Bella Vann!"
                  ),
                  a.createElement(
                    S.X6,
                    {
                  ...
                  a.createElement(
                    x.nv,
                    null,
                    "Jonathan Merrin, Charles Duval, Addison Kaufmann, Rachel Weil, Joseph Oak, Amanda Velasco Gallardo, Ramya Challa, Chris Pirih. Also to Bella!"
                  )
                )
              ),
